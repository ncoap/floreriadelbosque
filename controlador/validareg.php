    	...
    	case 'nuevousu':
		 ...
		 $direc=$_REQUEST['txtdirec'];
		  ...
		  $res=$cn->prepare("call buscarmail(:mail);");			
			...
			if($m==$mail){
                        $_SESSION['msg']='Ya hay alguien registrado con este Email';
		 	header('Location: ../vista/login.php');
			}elseif (@$nomusu==' ') {
		 	$_SESSION['msg']='Complete el campo Nombres';
		 	header('Location: ../vista/login.php');
		 }elseif (@$apeusu==' ') {
		 	$_SESSION['msg']='Complete el campo Apellidos';
		 	header('Location: ../vista/login.php');
		 }elseif (@$dni==' ') {
		 	$_SESSION['msg']='Complete el campo DNI';
		 	header('Location: ../vista/login.php');
		 }elseif (@$sexo==' ') {
		 	$_SESSION['msg']='Complete el campo Sexo';
		 	header('Location: ../vista/login.php');
		 }elseif (@$mail==' ') {
		 	$_SESSION['msg']='Complete el campo email';
		 	header('Location: ../vista/login.php');
		 }elseif (@$telefono==' ') {
		 	$_SESSION['msg']='Complete el campo teléfono';
		 	header('Location: ../vista/login.php');
		 }elseif (@$pass==' ') {
		 	$_SESSION['msg']='Complete el campo Password';
		 	header('Location: ../vista/login.php');
		 }elseif (@$direc==' ') {
		 	$_SESSION['msg']='Complete el campo Confirmar Password';
		 	header('Location: ../vista/login.php');
		 }elseif($m<>$mail){
