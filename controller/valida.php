...
switch ($accion) {    
     case 'editar':               
        ...
        $res->execute();
        header('refresh:0; url=../view/productos.php');
        break;
    case 'insertar':
        $ruta="../produc/";
        $codpro=$_REQUEST['codpro'];
    ...
    case 'nuevacate':
        ...
        $res->execute();
        header('refresh:0; url=../view/subcategoria.php');
        break;
    ...
    case 'editacate':
        ...
        $res->execute();
        header('refresh:0; url=../view/micuenta.php');
        break;
    ...
    case 'actdatos1':
        ...
        header('Location: ../view/micuenta.php');
        break;
        case 'borrahist';
        ...
        case 'editatarifa':
            ...
            $res->execute();
            header('refresh:0; url=../view/tarifas.php');
            break;
         case 'nuevatarifa':
            $zona=$_REQUEST['zona'];
            $tarifa=$_REQUEST['tarifa'];
        ...
        case 'datbanco':
            ...
            $res->execute();
            header('refresh:0; url=../view/tipocambio.php');
            break;
    default :
         header('Location: ../view/index.php');
        break;
