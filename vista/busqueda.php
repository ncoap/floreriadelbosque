            ...
            <header class="top">
                ...
                <div class="idiomas">
                    <ul>
                        ...
                        <li>
                            <a href="../vista/busqueda.php"><img  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../view/busqueda.php"><img  class="idiomanoselec" src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos">
            ...
            <div class="proxsub">
                  ...
                  echo '<p style="
                      ...
                      width:95%;
                        ...
                        color: #004a80;
                        ">Su búsqueda arrojó '.$numbus.' resultado(s)</p>';
                  ?>        
                <?php
                if(count($buscar)!=0){
