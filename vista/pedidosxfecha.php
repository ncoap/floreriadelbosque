    ...
    <ul class="nav">
            ...
            <li><a href="../controlador/controlador.php?codsub=<?php echo $row[0] ;?>&op=3">
             ...
             <div class="detpedi" id="detpedi">
                 <div class="detcaja">
                      <h2 align="center" style="border-bottom: 1px solid #d6d4d4;padding-bottom: 15px">Pedidos por Fecha</h2> <br>
             <form   action="../controlador/controlador.php" method="post">
                 <input type="hidden" name="op" value="11">
                 <input type="hidden" name="opp" value="a">
        <table align="center" >
            <h2>Por fecha de pedido</h2>
        	<tr>
        		<td>
                            Ingrese la primera fecha:   <input  type="date" required autofocus name="fec1">
                             Ingrese la segunda fecha:   <input  type="date" required autofocus name="fec2">
            ...
            <form action="../controlador/controlador.php" method="post">
                 <input type="hidden" name="op" value="11">
                  <input type="hidden" name="opp" value="b">
                 <table align="center" >
        	<tr>
                     <h2>Por fecha de Entrega</h2>
        		<td>
                            Ingrese la primera fecha:   <input  type="date" required autofocus name="fec1">
                             Ingrese la segunda fecha:   <input  type="date"  required autofocus name="fec2">
                            <input type="submit" value="Buscar"><br>	
            ...
            <article class="ventana3">
                <section class="form3">
                    <section  class="cerrar3"><a href="javascript:closeVentana();"><img src="../img/cancel.png"></a></section >
      
          <?php if(count($pedxfecha)>0){ ?>
          <table width="1530" class="tablaresul">
              ...
              <tr>
               ...
               <?php  }?>
                    ...
                    echo '<h2 align="center">No hay pedidos en ese rango de fechas</h2>';
               }
          ?>
          <h2 align="center"><form id="form1" name="form1" method="post" action="../reportes/repedidosxfecha.php">
            <input type="submit" value="Exportar a Excel">
        </form></h2>
     
            </section>
            </article>
            <h4 align="center"><a onclick="openVentana();" class="regist" href="#">Ver pedidos</a></h4>
            <div class="redsoc">
                 <ul class="redes">
