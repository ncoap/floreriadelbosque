...
<html>
    ...
    <ul class="nav">
        ...
        <div class="detpedi" id="detpedi">
                 <div class="detcaja">
                      <h2 align="center" style="border-bottom: 1px solid #d6d4d4;padding-bottom: 15px">Pedidos por Usuario</h2> <br>
             <form   action="../controlador/controlador.php" method="post">
                 <input type="hidden" name="op" value="9">
        <table align="center" >
        	<tr>
        		<td>
                            Ingrese Código del Usuario:   <input  type="text" autofocus name="codus">
          ...
          ?>
          <h2 align="center"><form id="form1" name="form1" method="post" action="../reportes/repedidosxusu.php">
