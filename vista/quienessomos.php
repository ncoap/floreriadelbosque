...
<html>
            ...
            <header class="top">
                ...
                <div class="idiomas">
                    <ul>
                        ...
                        <li>
                            <a href="../vista/quienessomos.php"><img  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../view/quienessomos.php"><img  class="idiomanoselec" src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos">
                    ...
                    <li><a href="quienessomos.php" class="selec">
                        QUIENES SOMOS</a>
                    </li>
    ...
    <ul class="nav">
            ...
            <div class="detcaja">
            <table class="nosotros">
                <tr>
                    <td><p class="titnoso">Nuestra Visión</p>
                    Posicionarnos en el corazón de nuestros clientes 
                    como la empresa peruana que, a través de la pasión
                    por brindar un servicio cálido y productos artesanales 
                    y creativos, es su aliada en todos los momentos 
                    especiales de su vida.</td>
                    <td class="imgnoso" rowspan="3"><img  src="../img/nosotros.jpg"></td>
                </tr>
                <tr>
                    <td><p class="titnoso">Nuestra Misión</p>
                   Trabajar con valores para que nuestros productos y 
                   servicios lleven los mensajes de paz, unión 
                   y felicidad de nuestros clientes a sus seres 
                   queridos.</td>
                </tr>
                <tr>
                    <td><p class="titnoso">Compra con Causa</p>
                    Como empresa nos preocupamos por ser parte de una
                    cadena de paz, entregamos los mejor de nosotros en 
                    nuestro trabajo y estamos agradecidos porque sabemos
                    que, así como queremos ser los aliados de nuestros
                    clientes en los momentos especiales de sus vidas,
                    también, al elegirnos, nos ayudan a cumplir nuestro 
                    sueño, y queremos que este sueño ayude a otros a 
                    cumplir los propios; es por ello que en nuestra
                    empresa encontrarás productos seleccionados en donde
                    un porcentaje de la ganancia se reúne para poder 
                    hacer una donación anual a instituciones de ayuda
                    social, como Aniquem y Emaús.</td>
                </tr>
            </table>
             <br>
             </div></div>
