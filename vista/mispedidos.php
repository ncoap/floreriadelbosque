                ...
                <div class="idiomas">
                    <ul>
                       <li class="carr">
                        ...
                        <li>
                            <a href="../vista/mispedidos.php"><img  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../view/mispedidos.php"><img  class="idiomanoselec" src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos">
            ...
            <article class="ventana3">
                <section class="form3">
                    <section  class="cerrar3">
                        <a href="../controlador/valida.php?accion=borrahist"><img width="35"  src="../img/borrahisto.png"></a>
          ...
          <table width="1530" class="tablaresul">
              ...
              <tr>
               ...
               <?php  }?>
                    ...
                    echo '<h2 align="center">No Tiene ningún pedido</h2>';
               }
          ?>
            ...
            <h4 align="center"><a class="regist" style="font-size: 32px" href="javascript:openVentana();">Ver pedidos</a></h4>
            <div class="redsoc">
                 <ul class="redes">
