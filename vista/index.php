                ...
                <div class="idiomas">
                    <ul>
                       <li class="carr">
                        ...
                        <li>
                            <a href="../vista/index.php"><img  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../view/index.php"><img  class="idiomanoselec" src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos">
                    <li><a href="../controlador/controlador.php?op=1" class="selec">
                        INICIO</a>
                    </li>
            ...
            <div class="destcd">
                ...
                <form action="../controlador/controlador.php" method="post">
                    <div class="prodes">
                          ...
                          <p class="nomdest"><?php echo $row[1].' ('.$row[5].')';?></p>
