...
if($_SESSION['rol']<>'A'){
      ...
      if(isset($_SESSION['detasubc'])){
$detasubc=$_SESSION['detasubc'];
}else{
    header('Location: ../index.php');
}  
...
<html>
    ...
    <ul class="nav">
            ...
            <li><a href="../controlador/controlador.php?codsub=<?php echo $row[0] ;?>&op=3">
             ...
             if(count($detasubc)!=0){
                    foreach ($detasubc as $row2){
            ?>  
             <h2 align="center" style="border-bottom: 1px solid #d6d4d4;padding-bottom: 15px">Editar Subcategoria <?php echo '"'.$row2[1].'"';?></h2><br>
             <form action="../controlador/valida.php" method="post">
                 <table align="center">
                     ...
                     <tr>
                         <td>Código</td>
                    <td><input type="text" name="codscat" value="<?php echo $row2[0];?>" readonly="readonly"></td>
                     </tr>
                     <tr>
                         <td>Nombre en Español</td>
                         <td><input type="text" name="nomscate" value="<?php echo $row2[1]?>" required></td>
                     </tr>
                     <tr>
                         <td>Nombre en Ingles</td>
                         <td><input type="text" name="nomscati" value="<?php echo $row2[2]?>" required></td>
                     </tr>
                      <tr>
                         <td>Estado :</td>
                  ...
                  <input type="hidden" name="accion" value="editacate">
             </form> <?php }}?>
             </div></div> 
            <div class="redsoc">
                 <ul class="redes">
