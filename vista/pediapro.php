...
<html>
    ...
    <ul class="nav">
          ...
          ?>
          <h2 align="center"><form id="form1" name="form1" method="post" action="../reportes/repediapro.php">
