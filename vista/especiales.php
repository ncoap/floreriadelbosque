            ...
            <header class="top">
                ...
                <div class="idiomas">
                    <ul>
                        ...
                        <li>
                            <a href="../vista/especiales.php"><img  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../view/especiales.php"><img  class="idiomanoselec" src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos">
                    ...
                    <li><a href="../controlador/controlador.php?op=4" class="selec">
                        ESPECIALES</a>
                    </li>
