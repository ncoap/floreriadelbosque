...
<html>
            ...
            <header class="top">
                ...
                <div class="idiomas">
                    <ul>
                        ...
                        <li>
                            <a href="../vista/micuenta.php"><img  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../view/micuenta.php"><img  class="idiomanoselec" src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos">
    ...
    <ul class="nav">
           ...
           <div class="cont-post1">
               ...
               <div>
          <a href="../controlador/controlador.php?op=16"><img src="../img/icopedido.png">
         <p class="titulo">Mis Pedidos</p></a>
        </div>
               <div>
          <a href="datospersonales.php"><img src="../img/icomisdatos.png">
         <p class="titulo">Mis Datos Personales</p></a>
        </div>
            </div><?php }?>
            <?php if($rol=='A') {?>
