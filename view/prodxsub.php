                ...
                <div class="idiomas">
                    <ul>
                       <li class="carr">
                        ...
                        <li>
                            <a href="../vista/prodxsub.php"><img class="idiomanoselec"  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../view/prodxsub.php"><img   src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos2">
                ...
                <form action="../controller/controlador.php" method="post">
                    <div class="proxs">
                          ...
                          <p class="nomdest"><?php echo $row[1].' ('.$row[12].')';?></p>
                            ...
                            <input type="submit" class="btnver" value="See" title="See">
