...
<html>
                ...
                <div class="idiomas">
                    <ul>
                       <li class="carr">
                        ...
                        <li>
                            <a href="../vista/contacto.php"><img class="idiomanoselec"  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../view/contacto.php"><img   src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos2">
    ...
    <ul class="nav">
            ...
            <div class="detcaja"><br>
                 <h1 class="titdetp">CUSTOMER SERVICE - CONTACT</h1>
                   <p>For questions about an order or for information about our products.</p><br>
                <form action="../controlador/envcorreo.php" method="post"> <table align="center" class="formcontac">
                        ...
                        <tr>
                            <td></td><td align="center"><input type="submit" name="btncore" class="btnver" value="Send"></td>
                        </tr>
                </table>
