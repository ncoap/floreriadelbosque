        ...
        <script src="../js/jquery.js"></script>
         ...
         <script>
            ...
            $(document).ready(function(){
               ...
               $("#txtnom").keypress(function(){
                  var nom=$("#txtnom").val();
                  $.ajax({
                      url:"subcateresul.php",
                      type:"get",
                      data:"nom="+nom,
                      success:function(result){
                          $("#mostrarDato").html(result);
                      }
                  });
               });
            });
                ...
                <div class="idiomas">
                    <ul>
                       <li class="carr">
                        ...
                        <li>
                            <a href="../vista/buscasubcate.php"><img  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../view/buscasubcate.php"><img  class="idiomanoselec" src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos">
    ...
    <ul class="nav">
            ...
            <li><a href="../controlador/controlador.php?codsub=<?php echo $row[0] ;?>&op=3">
              ...
              <div class="detpedi" id="detpedi">
                 <div class="detcaja">
                      <h2 align="center" style="border-bottom: 1px solid #d6d4d4;padding-bottom: 15px">Sub Categorias</h2> 
             <form autocomplete="off">
        <table align="center" class="form">
        	<tr>
        		<td>
                            Ingrese nombre de la Sub Categoria:   <input  type="text" autofocus id="txtnom">
                            <a href="subcategoria.php"><img class="desa" src="../img/agregar.png"></a><br>	
        		</td>
