...
<html>
    ...
    <ul class="nav">
           ...
           <?php            
            ...
            ?><h2 style="border-bottom: 1px solid #d6d4d4;padding-bottom: 15px" align="center">Editar Producto <?php echo '"'.$row[1].'"'; ?></h2><br>
            ...
            <table border="0" width="200" align="center">
                ...
                <tr>
                    <td>Código:</td>
                    <td><input type="text" class="textbox" name="codpro" readonly="readonly" value="<?php echo $row[0]; ?>"></td>
                </tr>
                <tr>
                    <td>Código de Venta:</td>
                    <td><input type="text" class="textbox" name="codvent" value="<?php echo $row[14]; ?>"></td>
                </tr>
                <tr>
                    <td>Nombre en Español:</td>
                    <td><input type="text" class="textbox" name="nomproe" value="<?php echo $row[1]; ?>"></td>
                </tr>
                <tr>
                    <td>Descripción en Español:</td>
                    <td><textarea name="desproe" cols="60" rows="8" class="textbox"  ><?php echo $row[2]; ?></textarea></td>
                </tr>
                <tr>
                    <td>Nombre en Ingles:</td>
                    <td><input type="text" class="textbox" name="nomproi" value="<?php echo $row[3]; ?>"></td>
                </tr>
                <tr>
                    <td>Descripción en Ingles:</td>
                    <td><textarea name="desproi" cols="60" rows="8" class="cajatext"  ><?php echo $row[4]; ?></textarea></td>
                </tr>
                <tr>
                <td>Estado: </td>
                ...
                <tr>
                    <td>Stock:</td>
                    <td><input type="number" min="0" class="textbox"  required name="stock" value="<?php echo $row[7]; ?>"></td>
                </tr>
                <tr>
                    <td>Precio:</td>
                    <td><input type="number" class="textbox" name="precio"  required value="<?php echo $row[8]; ?>"></td>
                </tr>
                <tr>
                    <td>Imagen 1:</td>
                    <td><input type="file"  class="textbox" name="imagen1"></td>
                </tr>
                <tr>
                    <td>Imagen 2:</td>
                ...
                <tr>
                <th colspan="2">
                    <input type="submit" name="btn1" value="Actualizar" id="boton1">
                    </th>
                </tr>
                <tr>
