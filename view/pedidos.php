...
<html>
    ...
    <ul class="nav">
            ...
            <li><a href="../controlador/controlador.php?codsub=<?php echo $row[0] ;?>&op=3">
               ...
               <div>
          <a href="pedxusu.php"><img src="../img/buscxu.jpg">
         <p class="titulo">Buscar por Usuario</p></a>
        </div>
               <div>
          <a href="pedidosxfecha.php"><img src="../img/buscxfec.png">
         <p class="titulo">Buscar por Fecha</p></a>
        </div>
             <div>
          <a href="../controlador/controlador.php?op=12"><img src="../img/pediaprob.png">
         <p class="titulo">Pedidos Aprobados</p></a>
        </div>
                   <div>
          <a href="../controlador/controlador.php?op=13"><img src="../img/pedipend.png">
         <p class="titulo">Pedidos Pendientes</p></a>
        </div>
                   <div>
          <a href="../controlador/controlador.php?op=14"><img src="../img/pediall.png">
         <p class="titulo">Todos los Pedidos</p></a>
        </div>
                   <div>
          <a href="pedxcod.php"><img src="../img/pedixcod.png">
         <p class="titulo">Buscar por Codigo</p></a>
        </div>
