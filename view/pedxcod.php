...
<html>
    ...
    <ul class="nav">
          ...
          <div class="detpedi" id="detpedi">
                 <div class="detcaja">
                      <h2 align="center" style="border-bottom: 1px solid #d6d4d4;padding-bottom: 15px">Pedidos por Código</h2><br> 
             <form   action="../controlador/controlador.php" method="post">
                 <input type="hidden" name="op" value="15">
        <table align="center" >
        	<tr>
        		<td>
                            Ingrese Código del Pedido:   <input  type="text" autofocus name="codpe">
