    ...
    <ul class="nav">
            ...
            <li><a href="../controlador/controlador.php?codsub=<?php echo $row[0] ;?>&op=3">
             ...
             <div class="detpedi" id="detpedi">
                 <div class="detcaja">
             <h2 align="center" style="border-bottom: 1px solid #d6d4d4;padding-bottom: 15px">Ingreso de Nuevas Subcategorias</h2><br>
             <form action="../controlador/valida.php" method="post">
                 <table align="center">
             <tr>
                <td>Categoria: </td>
                <td>
                    <select name="select_cat" class="textbox" >
            ...
            foreach ($res as $row){?>
                     ...
                     <tr>
                         <td>Código</td>
                    <?php             
            $res=$cn->prepare("select concat('sc',count(codsubcat)+1) as cod from subcategoria;");
            $res->execute();
            foreach ($res as $row){?><td><input type="text" name="codscat" value="<?php echo $row[0];?>" readonly="readonly"></td><?php }?>  
                     </tr>
                     <tr>
                         <td>Nombre en Español</td>
                         <td><input type="text" name="nomscate" required></td>
                     </tr>
                     <tr>
                         <td>Nombre en Ingles</td>
                         <td><input type="text" name="nomscati" required></td>
                     </tr>
                     <tr><td></td>
                         <td><input type="submit" value="Registrar"></td></tr>
                 </table>
                  <input type="hidden" name="accion" value="nuevacate">
             </form>
             </div></div> 
            <div class="redsoc">
                 <ul class="redes">
