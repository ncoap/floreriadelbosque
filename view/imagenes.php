...
<html>
    ...
    <ul class="nav">
            ...
            <div class="detpedi" id="detpedi">
                 <div class="detcaja">
             <h2 align="center" style="border-bottom: 1px solid #d6d4d4;padding-bottom: 15px">Administrar Imagenes</h2> 
            
            <h3 align="center">*Indicaciones*</h3>
            <p align="center" class="indica"><font color="red">Para cambiar el fondo:</font> Se debe adjuntar una 
                imagen alojada en algún disco de su equipo, nunca 
                en el escritorio o alguna carpeta que se encuentre 
                en él .La imagen de fondo tiene  de tener una 
                resolución mayor a 2050px x 1586  y tiene que llamarse body.jpg .</p><br>
            <p align="center" class="indica"><font color="red">Para cambiar las imágenes del banner:</font>
              Las imágenes tienen que tener una resolución exacta de 1064 x 475px.
              Todas las imágenes del banner tienen que tener la misma medida y 
              tienen que llamarse slider1.jpg, slider2.jpg y slider3.jpg.
              En este caso deberá ingresar las 3 imágenes una por una con los nombres respectivos.</p>
            
           <form action="../controlador/prosesar.php" method="post" enctype="multipart/form-data"><br>
		<table align="center">
                    <tr><td><input type="file" name="foto" required/></td>
