...
<html>
    ...
    <ul class="nav">
            ...
            <div class="detpedi" id="detpedi">
                 <div class="detcaja">
                      <h2 align="center" style="border-bottom: 1px solid #d6d4d4;padding-bottom: 15px">Productos</h2> 
             <form autocomplete="off">
        <table align="center" class="form">
        	<tr>
        		<td>
                            Ingrese nombre del Producto:   <input  type="text" autofocus id="txtnom">
                            <a href="nuevoprod.php"><img class="desa" src="../img/agregar.png"></a><br>	
        		</td>
            ...
            <div id="mostrarDato">
                ...
                <h2 align="center"><form id="form1" name="form1" method="post" action="../reportes/reproductos.php">
