    ...
    <ul class="nav">
            ...
            <li><a href="../controlador/controlador.php?codsub=<?php echo $row[0] ;?>&op=3">
             ...
             <br>     <div class="detpedi" id="detpedi">
                 <div class="detcaja">
             <h2 align="center" style="border-bottom: 1px solid #d6d4d4;padding-bottom: 15px">Ingreso de Nuevas Tarifas</h2><br>
             <form action="../controlador/valida.php" method="post">
                 <table align="center">
                     ...
                     <tr>
                         <td>Zona</td>
                         <td><input type="text" name="zona"   required></td>
                     </tr>
                     <tr>
                         <td>Tarifa</td>
                         <td><input type="number" name="tarifa" required></td>
                     </tr>
                  ...
                  <input type="hidden" name="accion" value="nuevatarifa">
             </form>
             </div></div> 
            <div class="redsoc">
                 <ul class="redes">
