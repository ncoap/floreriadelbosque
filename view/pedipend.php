    ...
    <ul class="nav">
          ...
          <table width="1530" class="tablaresul">
              ...
              <tr>
                    ...
                    <td>
                        <a href="../controlador/valida.php?codpedido=<?php echo $row[0];?>&accion=aprueped"><img  class="desa" src="../img/siapru.png"></a>
                        <a href="../controlador/controlador.php?codpedido=<?php echo $row[0];?>&op=10"><img class="desa" src="../img/ver.png"></a></td>
              </tr>
               <?php  }?>
          </table><?php 
          }else{
                    echo '<h2 align="center">El Usuario no Tiene ningún pedido</h2>';
               }
          ?>
          <h2 align="center"><form id="form1" name="form1" method="post" action="../reportes/repedipend.php">
