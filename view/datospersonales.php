                ...
                <div class="idiomas">
                    <ul>
                       <li class="carr">
                        ...
                        <li>
                            <a href="../vista/datospersonales.php"><img class="idiomanoselec"  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../view/datospersonales.php"><img   src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos2">
    ...
    <ul class="nav">
            ...
            <br>    
              <div class="detpedi" id="detpedi">
                 <div class="detcaja">
            <h2 style="border-bottom: 1px solid #d6d4d4;padding-bottom: 15px">YOUR PERSONAL DATA</h2><br>
            <?php 
