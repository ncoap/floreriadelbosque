...
<html>
                ...
                <div class="idiomas">
                    <ul>
                       <li class="carr">
                        ...
                        <li>
                            <a href="../vista/quienessomos.php"><img class="idiomanoselec"  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../view/quienessomos.php"><img   src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos2">
    ...
    <ul class="nav">
            ...
            <table class="nosotros">
                <tr>
                    <td><p class="titnoso">Our Vision</p>
                    To position in the heart of our clients
                    as the Peruvian company that, through 
                    the passion for delivering warm service 
                    and craft and creative products, is your 
                    ally in all the special moments of your life.</td>
                    <td class="imgnoso" rowspan="3"><img  src="../img/nosotros.jpg"></td>
                </tr>
                <tr>
                    <td><p class="titnoso">Our Mision</p>
                   Working with values for our products and
                      services bear the messages of peace, unity
                    and happiness of our customers loved
                    ones.</td>
                </tr>
                <tr>
                    <td><p class="titnoso">Cause Purchase</p>
                    As a company we care about being part of a
                    peace chain, we deliver the best of us
                    our work and we are grateful because we know
                    that just as we want to be our allies
                    customers in the special moments of their lives,
                    also, to choose us, help us meet our
                    dream, and we want this dream to help others
                    meet themselves; that is why in our
                    company we selected products where
                    a percentage of profit meets to
                    make an annual donation to aid institutions
                    social, as Aniquem and Emmaus.</td>
                </tr>
            </table>
                <br>
             </div></div>
