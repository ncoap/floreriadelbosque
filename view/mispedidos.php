...
<html>
                ...
                <div class="idiomas">
                    <ul>
                       <li class="carr">
                        ...
                        <li>
                            <a href="../vista/mispedidos.php"><img class="idiomanoselec"  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../view/mispedidos.php"><img   src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos2">
    ...
    <ul class="nav">
            ...
            <article class="ventana3">
                <section class="form3">
                    <section  class="cerrar3">
                        <a href="../controller/valida.php?accion=borrahist"><img width="35"  src="../img/borrahisto.png"></a>
                        <a href="javascript:closeVentana();"><img src="../img/cancel.png"></a></section >
          ...
          <table width="1530" class="tablaresul">
              ...
              <tr>
                    ...
                    <td><a href="../controller/controlador.php?codpedido=<?php echo $row[0];?>&op=10"><img class="desa" src="../img/ver.png"></a></td>
              </tr>
               <?php  }?>
          </table><?php 
          }else{
          ...
          ?>
            ...
            <h1 align="center"><a class="regist" style="font-size: 32px" style="font-size: 32px" href="javascript:openVentana();">View orders</a></h1>
             <div class="redsoc">
                 <ul class="redes">
