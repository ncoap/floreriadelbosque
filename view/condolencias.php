<?php
session_start();
if(isset($_SESSION['condole'])){
$condole=$_SESSION['condole'];
}else{
                ...
                <div class="idiomas">
                    <ul>
                       <li class="carr">
                        ...
                        <li>
                            <a href="../vista/condolencias.php"><img class="idiomanoselec"  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../view/condolencias.php"><img   src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos2">
