                ...
                <div class="idiomas">
                    <ul>
                       <li class="carr">
                        ...
                        <li>
                            <a href="../vista/especiales.php"><img class="idiomanoselec"  src="../img/spanol.jpg"></a>
                        </li>
                        <li>
                            <a href="../vista/especiales.php"><img   src="../img/ingles.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ul class="menudos2">
                    ...
                    <li><a href="../controller/controlador.php?op=4" class="selec">
                        SPECIAL</a>
                    </li>
